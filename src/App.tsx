...
import {
    ...
    IonContent,
    IonChip,
    IonButton, IonMenu, IonHeader, IonToolbar, IonTitle, IonPage, IonButtons, IonMenuButton, IonSplitPane
} from '@ionic/react';
...
import ContentTabs from "./components_app/ContentTabs";
    ...
    <IonReactRouter>
        ...
        <IonSplitPane contentId="main">
            ...
            <IonRouterOutlet id="main">
                ...
                */}
                <Route path="/tabs" render={() => <ContentTabs />} />
                <Route path="/account" component={Tab2} />
                <Route path="/login" component={Tab2} />
                <Route path="/signup" component={Tab2} />
                <Route path="/support" component={Tab2} />
                <Route path="/tutorial" component={Tab2} />
                <Route path="/" component={Tab2} exact />
            </IonRouterOutlet>
        </IonSplitPane>
