...
//=== DOC https://codesandbox.io/s/k3jo3j627?file=/src/styles.css:0-654
...
class Drag extends Component<myProps,myState> {
...
export default connect(read_from_state,write_to_state)( Drag );
